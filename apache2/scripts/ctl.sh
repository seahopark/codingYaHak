...
HTTPD_PIDFILE=/Applications/mampstack-5.6.31-0/apache2/logs/httpd.pid


HTTPD="/Applications/mampstack-5.6.31-0/apache2/bin/httpd -f /Applications/mampstack-5.6.31-0/apache2/conf/httpd.conf"
...
. /Applications/mampstack-5.6.31-0/apache2/bin/envvars
